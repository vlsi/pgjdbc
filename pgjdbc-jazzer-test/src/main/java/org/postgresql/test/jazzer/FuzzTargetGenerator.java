...
/**
 * Runs each {@code *FuzzTestGenerator} in turn to emit this module's {@code @FuzzTest} source.
 * The Gradle {@code generateJazzerFuzzTargets} task points at this one {@code main}, so it never has to
 * change as more generators are added.
 *
 ...
 * {@code generate(Path)} method and calling it from {@link #main(String[])}.
 *
