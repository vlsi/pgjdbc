 ...
 * ErrorResponse, 1 MiB (1048576 bytes) for NegotiateProtocolVersion, and 64 messages for the whole
 * authentication exchange. A NegotiateProtocolVersion option count must not exceed the number of
